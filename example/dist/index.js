...
// src/App.module.css
injectStyle("._3ZGRyq_black{color:#fff;text-align:center;background-color:#282c34}._3ZGRyq_container img{object-fit:contain;width:100%;height:100%}");
var App_module_default = { black: "_3ZGRyq_black", container: "_3ZGRyq_container" };

// src/Picture.tsx
var jsx_dev_runtime = __toESM(require_jsx_dev_runtime(), 1);
function Picture({ title, url, onClick }) {
  const { data: imgUrl } = usePromise(url);
  return imgUrl && jsx_dev_runtime.jsxDEV("div", {
...
function ZoomImage({ fullPath: fullPathPromise, onClose, onPrevious, onNext, title }) {
  return jsx_dev_runtime2.jsxDEV(jsx_dev_runtime2.Fragment, {
    children: [
      ...
      jsx_dev_runtime2.jsxDEV("div", {
        ...
        children: jsx_dev_runtime2.jsxDEV(Picture, {
          url: fullPathPromise,
          title,
          onClick: onClose
        }, undefined, false, undefined, this)
...
function ImageList({ tree, path, u }) {
  const [zoomIndex, setZoomIndex] = import_react2.useState(-1);
  import_react2.useEffect(() => {
    setZoomIndex(-1);
  }, [path]);
  const images = import_react2.useMemo(() => {
    return tree?.map((img) => {
  ...
  return jsx_dev_runtime3.jsxDEV(jsx_dev_runtime3.Fragment, {
    children: images?.[zoomIndex] ? jsx_dev_runtime3.jsxDEV(jsx_dev_runtime3.Fragment, {
      children: [
        ...
        " ",
        jsx_dev_runtime3.jsxDEV(ZoomImage, {
    ...
    }, undefined, true, undefined, this) : jsx_dev_runtime3.jsxDEV("div", {
      style: { display: "flex", flexWrap: "wrap" },
      children: images?.map((url, index) => jsx_dev_runtime3.jsxDEV("div", {
        style: {
          width: 100,
          height: 100
        },
        children: jsx_dev_runtime3.jsxDEV(Picture, {
          title: url,
          url: u(url),
          onClick: () => setZoomIndex(index)
        }, undefined, false, undefined, this)
      }, url, false, undefined, this))
    }, undefined, false, undefined, this)
  }, undefined, false, undefined, this);
}
...
function useGitTree({ author, name }) {
  const [tree, setTree] = import_react3.useState();
  const [fetching, setFetching] = import_react3.useState(false);
  const fetchTree = import_react3.useCallback(async () => {
    setFetching(true);
    if (author && name) {
      const tree_sha = await fetch(`${REPO_API}${author}/${name}/branches/master`).then((response) => response.json()).then((json) => json.commit.sha);
      const tree2 = await fetch(`${REPO_API}${author}/${name}/git/trees/${tree_sha}?recursive=true`).then((response) => response.json()).then((json) => json.tree);
      setFetching(false);
      return tree2;
    }
  }, [author, name]);
...
class Loader {
  ...
  getUrl(url, priority = Priority.HIGH) {
  ...
  #processQueue(priority) {
    if (this.loadingCount < this.#config.maxParallelLoad || priority === Priority.HIGH && this.loadingCount < this.#config.maxParallelLoad + 1 || priority === Priority.TOP) {
...
function useLoader({ urls }) {
  const loader = import_react4.useMemo(() => new Loader, []);
  const [loading, setLoading] = import_react4.useState(0);
  ...
  import_react4.useEffect(() => {
    urls?.forEach((u2) => {
      setLoading((l) => l + 1);
      loader.load(u2).then(() => setLoading((l) => l - 1));
    });
  }, [urls, loader]);
  const u = import_react4.useCallback((url) => loader.getUrl(url), [loader]);
...
function Links({ tree, path, setPath }) {
  const imagesPerLink = import_react5.useMemo(() => {
...
function App() {
  const [repo, setRepo] = import_react6.useState({
    name: "art",
    author: "jacklehamster"
  });
  const [path, setPath] = import_react6.useState("");
  const authorId = import_react6.useId();
  const repoId = import_react6.useId();
  const { tree } = useGitTree(repo);
  const images = import_react6.useMemo(() => {
  ...
  const authorRef = import_react6.useRef(null);
  const repoRef = import_react6.useRef(null);
  ...
  return jsx_dev_runtime5.jsxDEV(jsx_dev_runtime5.Fragment, {
    children: [
      jsx_dev_runtime5.jsxDEV(jsx_dev_runtime5.Fragment, {
        children: [
          jsx_dev_runtime5.jsxDEV("div", {
            children: [
              "This is a demo that uses",
              jsx_dev_runtime5.jsxDEV("a", {
                rel: "noopener",
                href: "https://www.npmjs.com/package/@dobuki/asset-loader",
                target: "_blank",
                children: " @dobuki/asset-loader "
              }, undefined, false, undefined, this),
              'in order to progressively load all images from a Github repository in one batch. Once the images are loaded, they are kept in memory to avoid further access to the server. Note: The repo you use must have public Github pages exposed to "root". We avoid using the Github API to open images, to avoid hitting API request limit. Enter the Github author and repo name below.'
            ]
          }, undefined, true, undefined, this),
          jsx_dev_runtime5.jsxDEV("p", {}, undefined, false, undefined, this),
          jsx_dev_runtime5.jsxDEV("div", {
            children: [
          ...
          jsx_dev_runtime5.jsxDEV("div", {
            children: jsx_dev_runtime5.jsxDEV("button", {
              className: App_module_default.black,
              type: "button",
              onClick: import_react6.useCallback(() => {
                const author = authorRef.current?.value;
                const repo2 = repoRef.current?.value;
                if (author && repo2) {
                  resetLoader();
                  setRepo({
                    name: repo2,
      ...
      jsx_dev_runtime5.jsxDEV("div", {
        ...
        children: [
          ...
          path.split("/").map((part, index) => jsx_dev_runtime5.jsxDEV("span", {
            children: [
              "/",
              jsx_dev_runtime5.jsxDEV("a", {
                style: {
      ...
      jsx_dev_runtime5.jsxDEV(jsx_dev_runtime5.Fragment, {
        children: path.length ? jsx_dev_runtime5.jsxDEV("div", {
          children: jsx_dev_runtime5.jsxDEV("button", {
            type: "button",
            onClick: () => {
              setPath((path2) => {
      ...
      tree ? jsx_dev_runtime5.jsxDEV(jsx_dev_runtime5.Fragment, {
        children: [
          jsx_dev_runtime5.jsxDEV(ImageList, {
            tree,
            path,
            u
          }, undefined, false, undefined, this),
          jsx_dev_runtime5.jsxDEV(Links, {
            tree,
            path,
            setPath
          }, undefined, false, undefined, this)
      ...
      jsx_dev_runtime5.jsxDEV(jsx_dev_runtime5.Fragment, {
        children: loading ? jsx_dev_runtime5.jsxDEV("div", {
          children: [
            "Loading images (",
            loading,
            ")..."
...
root.render(location.search.indexOf("strict-mode") >= 0 ? jsx_dev_runtime6.jsxDEV(import_react7.StrictMode, {
  children: jsx_dev_runtime6.jsxDEV(App, {}, undefined, false, undefined, this)
}, undefined, false, undefined, this) : jsx_dev_runtime6.jsxDEV(App, {}, undefined, false, undefined, this));
